...
$if(title)$
  \title{\bfseries{\color{BrickRed}{Course Title:}} $title$}
$else$
...
$if(author)$
  \author{\bfseries{Professor:} $author$}
...
$if(date)$
  ...
  % \postdate{\par}
  \date{\bfseries{Course Dates:} $date$}
$else$
  \date{\bfseries{Course Dates:} }
  % \predate{}\postdate{}
$endif$
...
\textbf{Term:} $if(term)$$term$$else$TBD$endif$ \\
\textbf{Credits:} $if(credits)$$credits$$else$TBD$endif$ & \textbf{Teaching Assistant:} $if(assistant)$$assistant$$else$TBD$endif$ \\
\textbf{E-mail:} $if(email)$\texttt{$email$}$else$TBD$endif$ & \textbf{Teaching Assistant E-Mail:} $if(assistantemail)$$assistantemail$$else$TBD$endif$ \\
\textbf{Class Hours:} $if(classhours)$$classhours$$else$TBD$endif$ & \textbf{Class Room:} $if(classroom)$$classroom$$else$TBD$endif$ \\
\textbf{Office:} $if(office)$$office$$else$TBD$endif$ & \textbf{Office Hours:} $if(officehours)$$officehours$$else$TBD$endif$ \\
	\end{tabular*}
