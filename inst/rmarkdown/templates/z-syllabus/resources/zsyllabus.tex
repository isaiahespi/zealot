...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={$for(author)$$author.name$ ($author.email$)$sep$ and $endfor$},
...
$if(title)$
$if(subtitle)$
  \textcolor{red}{\textbf{\title{$title$: $subtitle$}}}
  % \pretitle{\vspace{\droptitle}\centering\huge}
$else$
  \textcolor{red}{\textbf{\title{$title$}}}
$else$
  \title{}
...
$endif$
$if(author)$
  \textbf{Professor:}\author{$for(author)$$author$$sep$ \\ $endfor$}
  % \preauthor{\centering\large\emph}
  % \postauthor{\par}
$else$
  \textbf{Professor:}\author{}
  % \preauthor{}\postauthor{}
$endif$
$if(email)$
  \textbf{Email:}\email{$email$}
$else$
  \textbf{Email:}\email{}
$endif$
$if(officehours)$
  \textbf{Office Hours:}\officehours{$officehours$}
$else$
  \textbf{Office Hours:}\officehours{}
$endif$
$if(credits)$
  \textbf{Credits:}\credits{$credits$}
$else$
...
$if(date)$
  ...
  % \postdate{\par}
  \textbf{Course Dates:}\date{$date$}
$else$
  \textbf{Course Dates:}\date{}
  % \predate{}\postdate{}
$endif$
$if(classroom)$
  \textbf{Classroom:}\classroom{$classroom$}
$else$
  \textbf{Classroom:}\classroom{}
$endif$
$for(assistant)$
$if(assistant.name)$
  \textbf{Teaching Assistant:}\assistant{$assistant.name$$sep$, \\
  $if(assistant.email)$ \textbf{Teaching Assistant Email:} ($assistant.email$)$endfor$}
$else$
  \textbf{Teaching Assistant:}\assistant{$assistant$}
$else$
  \textbf{Teaching Assistant:}\assistant{}
$endif$
