...
term: "season/year"
author: "Professor(s)/Instructor(s) name"
date: "Start and end dates of the course"
...
Please visit [link](www.ugst.umd.edu/courserelatedpolicies.html) for the Office of Undergraduate Studies’ full list of campus-wide policies and follow up with me if you have questions.
...
- Grades and appeals
- Copyright and intellectual property
Please see the University's website for graduate course-related policies at: [link](https://gradschool.umd.edu/course-related-policies) 
...
**Email**: If you need to reach out and communicate with me, please email me at [email](xxxxxxxxx@umd.edu). Please DO NOT email me with questions that are easily found in the syllabus or on ELMS (i.e. When is this assignment due? How much is it worth? etc.) but please DO reach out about personal, academic, and intellectual concerns/questions.
...
```{r grading, warning=FALSE}

# Insert a table of your grading structure
# requires two R packages: `tidyverse` and `kableExtra`
# those were already included in the 'setup' R code chunk above

grade_tbl <- tibble::tribble(
                          ~Assignment, ~Percentage..,
                           "Homework",         "30%",
       "Quizzes and Weekly Summaries",         "15%",
           "Participation/Engagement",         "15%",
  "Team Project/ Paper/ Presentation",         "20%",
                         "Final Exam",         "20%",
                              "Total",        "100%"
...
kable(
  ...
  kable_styling(
    latex_options = c("striped", "basic", "hold_position"),
    position = "center",
    full_width = FALSE
  ) 

# Alternatively, simply include the raw LaTeX
# Copy and paste the below LaTeX into the document and delete this R-code chunk
# Don't forget to remove the pound signs '#' (Or 'hashtags')
...
~"", ~"Open Notes", ~"Use Book", ~"Search Online", ~"Ask Friends", ~"Work in Groups",
"Homework","\\{surd}","\\{surd}","\\{surd}","\\{surd}","\\{surd},",
"Quizzes and Weekly Summaries","\\{surd}",  "\\{surd}", "\\{surd}", "X", "X",
"Team Project/ Paper/ Presentation","\\{surd}","\\{surd}","\\{surd}","\\{surd}","\\{surd}",
"Final Exam","\\{surd}", "\\{surd}", "X", "X", "X"
)
...
#  & Open Notes & Use Book & Search Online & Ask Friends & Work in Groups\\
# \hline
# \cellcolor{gray!6}{Homework} & \cellcolor{gray!6}{\textbackslash{}\{surd\}} & \cellcolor{gray!6}{\textbackslash{}\{surd\}} & \cellcolor{gray!6}{\textbackslash{}\{surd\}} & \cellcolor{gray!6}{\textbackslash{}\{surd\}} & \cellcolor{gray!6}{\textbackslash{}\{surd\},}\\
# \hline
# Quizzes and Weekly Summaries & \textbackslash{}\{surd\} & \textbackslash{}\{surd\} & \textbackslash{}\{surd\} & X & X\\
# \hline
# \cellcolor{gray!6}{Team Project/ Paper/ Presentation} & \cellcolor{gray!6}{\textbackslash{}\{surd\}} & \cellcolor{gray!6}{\textbackslash{}\{surd\}} & \cellcolor{gray!6}{\textbackslash{}\{surd\}} & \cellcolor{gray!6}{\textbackslash{}\{surd\}} & \cellcolor{gray!6}{\textbackslash{}\{surd\}}\\
# \hline
# Final Exam & \textbackslash{}\{surd\} & \textbackslash{}\{surd\} & X & X & X\\
# \hline
# \end{tabular}
# \end{table}
